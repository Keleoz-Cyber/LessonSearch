...
> 版本：0.7.0+34 | 更新日期：2026-06-23 | 仓库：https://github.com/Keleoz-Cyber/LessonSearch
...
App 内置了【常见问题与解决方案】页面（设置 → 常见问题与解决方案），包含以下类别：
...
**实现文件**：`app/lib/features/settings/presentation/faq_page.dart`
