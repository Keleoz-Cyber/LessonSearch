...
> 最后更新：2026-04-13 · 当前稳定版本：0.5.3
> 进行中：v0.5.5（可选更新，不影响 0.5.3）
...
| docs/排行榜功能计划.md | v0.5.5 排行榜开发计划 |

---

## 十、v0.5.5 开发进度（可选更新）

**状态：进行中，不影响 v0.5.3 稳定版本**

### 已完成

- ✅ 记名按钮逻辑优化（有pending自动跳转，无pending不跳转）

### 待开发

- 🚧 排行榜功能（详见 docs/排行榜功能计划.md）
  - 三种周期：近7天、近30天、总榜
  - 三种榜单：综合异常分数、缺勤率、缺勤人次
  - 服务端定时任务（每天凌晨2点）
  - 前端排行榜页面